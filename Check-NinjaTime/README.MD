...
When **InvertExitCode** is enabled, exit codes 0 and 1 are swapped (2 is unchanged); configure the compound condition so that **exit code 0** is treated as condition met.
